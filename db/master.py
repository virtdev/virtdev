...
class MasterServer(object):
    def __init__(self):
        self._usr_server = MasterCache('usrsrv', server_info(DATA_SERVERS))
        self._dev_server = MasterCache('devsrv', server_info(DATA_SERVERS))
        self._usr_finder = MasterCache('usrfnd', FINDER_SERVERS, USR_FINDER_PORT)
        self._dev_finder = MasterCache('devfnd', FINDER_SERVERS, DEV_FINDER_PORT)
        self._usr_mapper = MasterCache('usrmap', MAPPER_SERVERS, USR_MAPPER_PORT)
        self._dev_mapper = MasterCache('devmap', MAPPER_SERVERS, DEV_MAPPER_PORT)
