...
from lib.util import USER_DOMAIN, DEVICE_DOMAIN, zmqaddr
    ...
    def _update_mappers(self):
        ...
        while True:
            try:
                ...
                if not cnt:
                    self._do_update_mappers(USER_DOMAIN)
                    cnt += 1
                else:
                    self._do_update_mappers(DEVICE_DOMAIN)
                    cnt = 0
            except:
                pass
